...
function getWeight(item) {
    ...
    let weight = weightKg !== null ? parseInt(weightKg[1]) : weightGr !== null ? parseInt(weightGr[1]) / 1000 : 1;
 ...
 */
var loaderIntervalHandler = setInterval(function() {

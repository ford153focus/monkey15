...
document.querySelector('.sorter.author').onclick = function(){Sort.byAuthor();}
document.querySelector('.sorter.downloads').onclick = function(){Sort.byDownloads();}
document.querySelector('.sorter.name').onclick = function(){Sort.byName();}
